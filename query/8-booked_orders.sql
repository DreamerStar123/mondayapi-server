SELECT dbo.SO_Detail.Promised_Date, dbo.SO_Detail.Sales_Order, dbo.SO_Detail.SO_Line, dbo.SO_Detail.Material, dbo.SO_Detail.Order_Qty, dbo.SO_Detail.Shipped_Qty, dbo.Material_Location.On_Hand_Qty, dbo.SO_Detail.Order_Qty - dbo.SO_Detail.Shipped_Qty AS Delta, dbo.SO_Detail.Status, dbo.Job.Job
